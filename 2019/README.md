...
マッピングとは、注目する遺伝子群や解析結果をパスウェイの画像の上に、主に色を付けることで視覚的に表現することになります
...
- 最近のブラウザなら問題ないと思います。今回の講習では一応Google Chromeを推奨いたしますが、Firefox、Safari、Edge、Operaなどでも問題ないと思います。ただしInternet Explorerは古すぎるので動作を保証していません。
---
## jPOSTdbとは
